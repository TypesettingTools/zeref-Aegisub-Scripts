...
gradient_modes = {"Vertical", "Horizontal"}
INTERFACE = {
    {class: "dropdown", name: "mode", items: gradient_modes, value: gradient_modes[1], x: 6, y: 1}
...
gradient = (subs, sel) ->
    ...
    if bx == "Run"
        ...
        for _, i in ipairs(sel)
            ...
            shape or= zf.shape(zf.text\to_clip(l, detect))\unclip(l.styleref.align)\build!
