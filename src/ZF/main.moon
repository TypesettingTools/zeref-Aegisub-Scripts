...
files = {
    ...
    paths:   {export_name: "PATHS",   module_name: "ZF.2D.paths",    version: "1.0.1"}
    ...
    shape:   {export_name: "SHAPE",   module_name: "ZF.2D.shape",    version: "1.1.2"}
    -- img
    ...
    -- text
    tags:    {export_name: "TAGS",    module_name: "ZF.text.tags",   version: "2.0.0"}
    text:    {export_name: "TEXT",    module_name: "ZF.text.text",   version: "1.3.5"}
    -- util
    config:  {export_name: "CONFIG",  module_name: "ZF.util.config", version: "1.0.1"}
    math:    {export_name: "MATH",    module_name: "ZF.util.math",   version: "1.0.0"}
    util:    {export_name: "UTIL",    module_name: "ZF.util.util",   version: "1.2.6"}
    fbf:     {export_name: "FBF",     module_name: "ZF.util.fbf",    version: "1.0.1"}
